...
:::   [92mÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»[0m
:::   [92mº[0m[94m          _____                                                  _     _    _  _    _  _  _  _                 [0m[92mº[0m
:::   [92mº[0m[94m         |  __ \                                                | |   | |  | || |  (_)| |(_)| |                [0m[92mº[0m
:::   [92mº[0m[94m         | |__) |___ __      __ ___  _ __   ___   ___   _ __  __| |   | |  | || |_  _ | | _ | |_  _   _        [0m[92mº[0m
:::   [92mº[0m[94m         |  ___// _ \\ \ /\ / // _ \| '__| / __| / _ \ | '__|/ _` |   | |  | || __|| || || || __|| | | |       [0m[92mº[0m
:::   [92mº[0m[94m         | |   | (_) |\ V  V /|  __/| |   | (__ | (_) || |  | (_| |   | |__| || |_ | || || || |_ | |_| |       [0m[92mº[0m
:::   [92mº[0m[94m         |_|    \___/  \_/\_/  \___||_|    \___| \___/ |_|   \__,_|    \____/  \__||_||_||_| \__| \__, |       [0m[92mº[0m
:::   [92mº[0m[94m                                                                                                   __/ |       [0m[92mº[0m
:::   [92mº[0m[94m                                                                                                  |___/        [0m[92mº[0m
:::   [92mº[0m[94m                                                                                                               [0m[92mº[0m
:::   [92mº[0m[94m                                             Made by Ryah#1518                                                 [0m[92mº[0m
:::   [92mº[0m[94m                                                                                                               [0m[92mº[0m
:::   [92mº[0m[94m                            Not affiliated with Discord or Powercord in any way.                               [0m[92mº[0m
:::   [92mº[0m[94m                           Powercord is against Discord ToS. Use at your own risk!                              [0m[92mº[0m
:::   [92mÈÍËÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
...
echo      [92mº[0mChecking Prerequisites      [92mº[0m
echo      [92mÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶[0m
rem timeout /t 1 >nul
rem Check if "git --version" is a recognized command
git --version >nul 2>&1 && (
	echo      [92mºFound Git                   º[0m
   rem timeout /t 1 >nul
   rem Check if "node -v" is a recognized command
   node -v >nul 2>&1 && (
	echo      [92mºFound NodeJS                º[0m
      rem Check if the ".dead" file is present in "%appdata%/../Local/DiscordCanary"
      if exist %appdata%/../Local/DiscordCanary/.dead (
			echo      [92mº                            º[0m
			echo      [92mº[0m[91mDiscord Canary NOT Found[0m    [92mº[0m
			echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
         echo.
      ...
      exit
			...
			echo      [92mºFound Discord Canary        º[0m
			echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
         timeout /t 1 >nul
         goto :MENU
      )
		...
		echo      [92mº                            º[0m 
		echo      [92mº[0m[91mNodeJS NOT Found[0m            [92mº[0m
		echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
      echo.
	...
	echo      [92mº                            º[0m
	echo      [92mº[0m[91mGit NOT Found[0m               [92mº[0m
	echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
   echo.
...
rem Display Header
for /f "delims=: tokens=*" %%A in ('findstr /b ::: "%~f0"') do @echo(%%A
echo      [92mº[0m      Select an option      [92mº[0m
echo      [92mÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶[0m
echo      [92mº[0m 1. Install Powercord       [92mº[0m
echo      [92mº[0m 2. Uninstall Powercord     [92mº[0m
echo      [92mÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶[0m  
echo      [92mº[0m 3. Manually Install Plugin [92mº[0m
echo      [92mº[0m 4. Manually Install Theme  [92mº[0m
echo      [92mº[0m                            [92mº[0m
echo      [92mº[0m 5. Quit                    [92mº[0m
echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
echo.
set "x=0"
:MenuLoop
...
if "%App%" EQU "Install PowerCord" (
   ...
   for /f "delims=: tokens=*" %%A in ('findstr /b ::: "%~f0"') do @echo(%%A
   echo      [92mº[0m[95m    Installing Powercord    [92mº[0m
   echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
   echo.
...
if "%App%" EQU "Uninstall Powercord" (
   ...
   for /f "delims=: tokens=*" %%A in ('findstr /b ::: "%~f0"') do @echo(%%A
    echo      [92mº[0m[95m   Uninstalling Powercord   [92mº[0m
    echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
...
if "%App%" EQU "Install Plugin" (
   ...
   for /f "delims=: tokens=*" %%A in ('findstr /b ::: "%~f0"') do @echo(%%A
    echo      [92mº[0m[95m      Installing Plugin     [92mº[0m
    echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
...
if "%App%" EQU "Install Theme" (
   ...
   for /f "delims=: tokens=*" %%A in ('findstr /b ::: "%~f0"') do @echo(%%A
    echo      [92mº[0m[95m      Installing Theme      [92mº[0m
    echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
...
cls
for /f "delims=: tokens=*" %%A in ('findstr /b ::: "%~f0"') do @echo(%%A
echo      [92mº[0mInstalling Prerequisites    [92mº[0m
echo      [92mÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼[0m
echo.
